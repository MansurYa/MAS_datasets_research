...
| Время | 0.30 сек |
| Хэш данных | `3b0be8486e79c4f5...` |
| График | work/plots/distribution_validator/audit-LN2-N15597-REJECT.png |
...
|---|---|---|
| D_obs | 0.0393 | Макс. отклонение ECDF от CDF |
| p_value | N/A | Односторонний p-value |
| p_final | 1.3068779286720474e-10 | Meinshausen: 2 × median(p₁..p_K) |
...
| 3 | utils | compute_data_hash | 3b0be8486e79c4f5... |
