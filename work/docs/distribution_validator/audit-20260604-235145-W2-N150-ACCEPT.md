...
| Время | 0.19 сек |
| Хэш данных | `8f23da42834e80fc...` |
| График | work/plots/distribution_validator/audit-W2-N150-ACCEPT.png |
...
|---|---|---|
| D_obs | 0.1042 | Макс. отклонение ECDF от CDF |
| p_value | N/A | Односторонний p-value |
| p_final | 0.7782422883654515 | Meinshausen: 2 × median(p₁..p_K) |
...
| 3 | utils | compute_data_hash | 8f23da42834e80fc... |
