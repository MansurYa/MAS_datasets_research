...
| График | work/plots/distribution_validator/audit-W3-N424-ACCEPT.png |
...
|---|---|---|
| D_obs | 0.0806 | Макс. отклонение ECDF от CDF |
| p_value | N/A | Односторонний p-value |
| p_final | 0.2551305268029612 | Meinshausen: 2 × median(p₁..p_K) |
| p_LRT | 9.557240925676631e-19 | LRT 2P vs 3P |
