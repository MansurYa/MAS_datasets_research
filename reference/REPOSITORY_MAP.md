...
**Статус:** Старый цикл (ТЗ №1–7) отклонён Huawei → архив. Новый цикл: TZ_1–TZ_6 завершены.
...
| `AGENT_TRAJECTORY_DATASETS.md` | Справочник датасетов (основной документ) |
| `reliability-docs.md` | Документация по надёжности и анализу выживаемости |
